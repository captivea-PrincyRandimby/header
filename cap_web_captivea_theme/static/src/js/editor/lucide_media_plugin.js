...
import { LucideSelector } from "@cap_web_captivea_theme/js/editor/lucide_selector";

/**
 * Adds a "Lucide" tab to the editor MediaDialog by contributing the
 * media_dialog_extra_tabs resource read by html_editor's MediaPlugin.
 */
